            ...
            <div class="row text-center mx-auto">
                ...
                <div class="col-md-6 col-lg-6">
                    ...
                    <div class="card m-b-20">
                        <img class="card-img-top img-fluid" src="../../assets/images/gallery/pasien_lama_umum.jpg" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-md-6 col-lg-6">
                    ...
                    <!-- Simple card -->
                    <div class="card m-b-20">
                        <img class="card-img-top img-fluid" src="../../assets/images/gallery/pasien_lama_bpjs.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title">BPJS</h4>
                            <p class="card-text">Antrian Untuk Pasien BPJS</p>
                            <a href="pasienlama/bpjs" style="width: 100%;" class="btn btn-primary btn-lg pull-right">Button</a>
                        </div>
                    </div>
